...
subj="[c9d6b80c-76ab-4f25-bd9c-fcf9dfcf70ec] AWS Message Services - Master Node"
res=sns.publish(mytopic_arn,msg,subj)
EOF

echo "deploy product from script" >> /tmp/deploy_result.txt
echo "master ip: 172.27.243.13" >> /tmp/deploy_result.txt
echo "slave ip: rN8agvsxd" >> /tmp/deploy_result.txt
