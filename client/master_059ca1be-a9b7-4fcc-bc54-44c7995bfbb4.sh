...
subj="[059ca1be-a9b7-4fcc-bc54-44c7995bfbb4] AWS Message Services - Master Node"
res=sns.publish(mytopic_arn,msg,subj)
EOF

echo "deploy product from script" >> /tmp/deploy_result.txt
echo "master ip: 172.27.73.43" >> /tmp/deploy_result.txt
echo "slave ip: vM8mxighz" >> /tmp/deploy_result.txt
