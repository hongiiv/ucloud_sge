...
msg = msg + "Master IP: 172.27.248.31 / PW: tP2tiqqhm"
subj="[0888f52a-eccf-4818-8627-ea14c2ec82d4] AWS Message Services - Master Node"
res=sns.publish(mytopic_arn,msg,subj)
EOF

echo "deploy product from script" >> /tmp/deploy_result.txt
echo "master ip: 172.27.248.31" >> /tmp/deploy_result.txt
echo "slave ip: tP2tiqqhm" >> /tmp/deploy_result.txt
