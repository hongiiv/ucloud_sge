...
subj="[47b370d5-3b19-4c9b-8f2b-83d6c2988dbc] AWS Message Services - Master Node"
res=sns.publish(mytopic_arn,msg,subj)
EOF

echo "deploy product from script" >> /tmp/deploy_result.txt
echo "master ip: 172.27.192.255" >> /tmp/deploy_result.txt
echo "slave ip: bA3tyapra" >> /tmp/deploy_result.txt
